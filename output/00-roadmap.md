...
| T02    | Modi sicher unterscheiden (`Ask`, `Plan`, `Agent`, `Debug`) und Einsatzfälle erklären | `02`    | [Section 02](sections/02/section.md) | [Agent Overview](https://cursor.com/docs/agent/overview.md), [Plan Mode](https://cursor.com/docs/agent/plan-mode.md), [Debug Mode](https://cursor.com/docs/agent/debug-mode.md)             | ✅      | `done`    |
