...
- `v0.2.0` - `output/sections/02/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/03/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/04/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/05/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/06/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/07/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.
- `v0.2.0` - `output/sections/08/section.md` - Abschnitt `Docs-Referenzen` mit Cursor-Links ergänzt.

## 2026-03-11
- `v0.1.0` - `output/Workshop.md` - Initialer Workshop-Backbone mit 8 Sections, Zeiten, Speaker-Zuordnung und Demo-Marker.
- `v0.1.0` - `output/sections/01/section.md` - Section-Template mit Contract, Navigation und Startinhalt erstellt.
- `v0.1.0` - `output/sections/02/section.md` - Section-Template mit Contract, Navigation und Startinhalt erstellt.
- `v0.1.0` - `output/sections/03/section.md` - Section-Template mit Contract, Navigation und Kern-Demo erstellt.
- `v0.1.0` - `output/sections/04/section.md` - Section-Template mit Contract, Navigation und Startinhalt erstellt.
- `v0.1.0` - `output/sections/05/section.md` - Section-Template mit Contract, Navigation und Kern-Demo erstellt.
- `v0.1.0` - `output/sections/06/section.md` - Section-Template mit Contract, Navigation und Startinhalt erstellt.
- `v0.1.0` - `output/sections/07/section.md` - Section-Template mit Contract, Navigation und Kern-Demo erstellt.
- `v0.1.0` - `output/sections/08/section.md` - Section-Template mit Contract, Navigation und Startinhalt erstellt.
- `v0.1.0` - `Workflow.md` - Verbindliche Navigations-, Versions- und Changelog-Regeln ergänzt.
- `v0.1.0` - `input/03-constraints.md` - Workflow-Constraints für Iteration, Verlinkung und Versionierung ergänzt.
