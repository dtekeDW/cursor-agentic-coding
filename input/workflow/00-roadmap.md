...
| T05    | Skills pragmatisch zeigen (Changeset, Jira) — Subagents nur kurz in Plan-Mode erwähnt | `05`    | [Section 05](../../output/sections/05/section.md) | [Skills](https://cursor.com/docs/skills.md)                                                                                                                                                  | ❌      | `next`    |
| T06    | Debug Mode Showcase + minimale Safety-Hinweise                                        | `06`    | [Section 06](../../output/sections/06/section.md) | [Debug Mode](https://cursor.com/docs/agent/debug-mode.md), [Agent Security](https://cursor.com/docs/agent/security.md)                                                                       | ❌      | `next`    |
