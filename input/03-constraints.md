...
# Goal
## - More interaction with LLM rather than just prompting within chat
## - Show how to use LLMs in a more agentic way, where the LLM can take actions and make decisions based on the context of the code and the task at hand.
